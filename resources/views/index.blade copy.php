             ...
             <div class="carousel-inner" role="listbox">
                    @for ($i = 0; $i < count($sliders); $i++)
                        @if($i == 0)
                            ...
                            <div class="item active">
                                <!-- Slide Background -->
                                <img src="{{url('/')}}/assets/images/sliders/{{$sliders[$i]->image2}}" alt=""  style="width: 100%; max-height: 400px; margin: auto;" />
                                <div class="bs-slider-overlay"></div>
                                <div class="container">
                                    <div class="row">
                                        <!-- Slide Text Layer -->
             ...
             <div class="carousel-inner" role="listbox">
                    @for ($i = 0; $i < count($sliders); $i++)
                        @if($i == 0)
                            ...
                            <div class="item active">
                                <!-- Slide Background -->
                                <img src="{{url('/')}}/assets/images/sliders/{{$sliders[$i]->image3}}" alt=""  style="width: 100%; max-height: 400px; margin: auto;" />
                                <div class="bs-slider-overlay"></div>
                                <div class="container">
                                    <div class="row">
                                        <!-- Slide Text Layer -->
