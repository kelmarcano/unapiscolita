                    ...
                    <div class="col-md-12 order-div">
                        <div class="col-md-7 order-left">
                            ...
                            <form class="col-md-offset-2 col-md-8" action="{{route('payment.submit')}}" method="post" id="payment_form">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="dni" value="" placeholder="DNI(RUN)" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="dni" value="{{Auth::guard('profile')->user()->dni}}" placeholder="DNI(RUN)" required>
                                </div>
                                <div class="form-group">
